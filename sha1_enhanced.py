...
class SHA1Hash:
    ...
    def final_hash(self):
        ...
        for block in self.blocks:
            ...
            print(f"Process message in 512-bit blocks Iteration :")
            print(f"{hex(self.h[0])[2:]} + {hex(a)[2:]} = {hex((a + self.h[0]) & 0xffffffff)[2:]}")
            print(f"{hex(self.h[1])[2:]} + {hex(b)[2:]} = {hex((b + self.h[1]) & 0xffffffff)[2:]}")
            print(f"{hex(self.h[2])[2:]} + {hex(c)[2:]} = {hex((c + self.h[2]) & 0xffffffff)[2:]}")
            print(f"{hex(self.h[3])[2:]} + {hex(d)[2:]} = {hex((d + self.h[3]) & 0xffffffff)[2:]}")
            print(f"{hex(self.h[4])[2:]} + {hex(e)[2:]} = {hex((e + self.h[4]) & 0xffffffff)[2:]}")
...
def main():
    ...
    parser.add_argument(
        "--string",
        dest="input_string",
        default="",
